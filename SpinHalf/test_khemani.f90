program flip
  ...
  use observables, only: gap_ratio, spectral_pairing => log_gap_difference, &
    ...
    & exact_QE => exact_quasi_energies_Flip, exact_E => exact_energies
  ...
  !$OMP DO private(i, hx, hy, hz, Vzz, H_c, E, W_c, &
  !$OMP & U, W, PH)
  do i = 1, n_disorder
