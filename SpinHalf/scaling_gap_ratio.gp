...
#plot for [i=0:num_L-1] file every :::f(i,j,k)::f(i,j,k) u 1:2:3:4:5:6:7:8:9 w table
#unset table
#print "Table"
#print $DataSelected
#  }
...
set output "figures/Swap_LR_Gap_Ratio_wrt_J_kick".kick."_alpha".alpha."_L".word(list_L,num_L).".png"
set title "N_d = 2^{1-L/2}20480, T0 = ".T0.", V = ".V.", kick = ".kick.",\n hz = ".hz.", alpha = ".alpha
plot for [i=0:num_L-1] file every :::f(i,j,k)::f(i,j,k) u 2:8:9 w errorlines title "L = ".word(list_L,i+1) lc palette frac (i+0.0)/num_L pt 4
